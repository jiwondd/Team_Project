...
path_dir = "C:/Team_pro/DATA/crawling/CHA/"  
...
def Cutting_face_save(image, name):
    ...
    for (x,y,w,h) in faces:
        ...
        # 이미지 저장하기
        cv2.imwrite(f"C:/Team_pro/DATA/crawling/CHA/cut_face/{name}.jpg", resize)
        
for name in file_name_list:
    img = cv2.imread("C:/Team_pro/DATA/crawling/CHA/cut_face/"+name+".jpg")
